...
while True:
    ...
    input_shape = outputs[2]
    predictions[:, :4] = scale_coords(input_shape[2:], predictions[:, :4], image_shape).round()
    ...
    for i, (x0, y0, x1, y1, score, cls_id) in enumerate(predictions):
